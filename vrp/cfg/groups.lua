...
-- PAISANA PMERJ
	...
	-- Mecanicas
	------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	["LiderBennys"] = { _config = { gtype = "org", salario = 12000, ptr = nil, orgName = "Bennys" },"perm.gerentebennys","per.baubennys","perm.Bennys", "dv.permissao","perm.recrutamentobennys", "mecanico.permissao",'perm.bennys','perm.liderbennys', "perm.algemar"},
	["SubLiderBennys"] = { _config = { gtype = "org", salario = 10000, ptr = nil, orgName = "Bennys" },"perm.gerentebennys","per.baubennys","perm.Bennys", "dv.permissao", "mecanico.permissao","perm.recrutamentobennys",'perm.bennys','perm.liderbennys', "perm.algemar"},
	["GerenteBennys"] = { _config = { gtype = "org", salario = 8000, ptr = nil, orgName = "Bennys" },"perm.gerentebennys","per.baubennys","perm.Bennys", "dv.permissao", "mecanico.permissao","perm.recrutamentobennys",'perm.bennys', "perm.algemar"},
	["MecanicoBennys"] = { _config = { gtype = "org", salario = 6000, ptr = nil, orgName = "Bennys" }, "dv.permissao","per.baubennys","perm.Bennys", "mecanico.permissao","perm.recrutamentobennys",'perm.bennys', "perm.algemar"},
	["AprendizBennys"] = { _config = { gtype = "org", salario = 3000, ptr = nil, orgName = "Bennys" }, "perm.Bennys","mecanico.permissao",'perm.mecanica'},

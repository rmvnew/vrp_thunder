...
function taskBar(difficulty,skillGapSent)
	TriggerEvent("thunder_inventory:emitNuiEvent",{
...
-- TASKFISHING
-----------------------------------------------------------------------------------------------------------------------------------------
-- Configurações para o taskFishing
local function taskFishing()
    local finished = taskBar(8000, math.random(6, 10)) -- Tempo de 8 segundos para o primeiro task
    if finished then
        return true
    end
    return false
...
-- Configurações para o taskFishing2
local function taskFishing2()
    local finished = taskBar(1000, math.random(6, 10)) -- Tempo de 1 segundo para o segundo task
    if finished then
        return true
    end
    return false
...
local function taskFishing3()
    local finished = taskBar(8000, math.random(6, 10)) -- Tempo de 1 segundo para o segundo task
    if finished then
        return true
    end
    return false
...
exports("taskFishing2", taskFishing2)
exports("taskFishing3", taskFishing3)
